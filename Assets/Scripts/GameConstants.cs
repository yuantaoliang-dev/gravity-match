...
public static class GameConstants
{
    ...
    public const float BHGrowthRadius = 0.001f * WorldScale;    // per ball absorbed (reduced for visual balance)
    public const float BHGrowthEH = 0.0015f * WorldScale;        // per ball absorbed
